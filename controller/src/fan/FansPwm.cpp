...
#if defined(FAN0)
    if(!configureFanPwm(FAN0_INDEX, FAN0_PWM_CHANNEL, FAN0_PWM_RESOLUTION_BITS, FAN0_PWM_FREQUENCY_HZ, FAN0_PWM_DEFAULT_DUTY,
                        FAN0_PWM_ERROR_DUTY, FAN0_PWM_MIN_DUTY, FAN0_PWM_MAX_DUTY, FAN0_PWM_GPIO_NUM))
        success = false;
#endif
#if defined(FAN1)
    if(!configureFanPwm(FAN1_INDEX, FAN1_PWM_CHANNEL, FAN1_PWM_RESOLUTION_BITS, FAN1_PWM_FREQUENCY_HZ, FAN1_PWM_DEFAULT_DUTY,
                        FAN1_PWM_ERROR_DUTY, FAN1_PWM_MIN_DUTY, FAN1_PWM_MAX_DUTY, FAN1_PWM_GPIO_NUM))
        success = false;
#endif
#if defined(FAN2)
    if(!configureFanPwm(FAN2_INDEX, FAN2_PWM_CHANNEL, FAN2_PWM_RESOLUTION_BITS, FAN2_PWM_FREQUENCY_HZ, FAN2_PWM_DEFAULT_DUTY,
                        FAN2_PWM_ERROR_DUTY, FAN2_PWM_MIN_DUTY, FAN2_PWM_MAX_DUTY, FAN2_PWM_GPIO_NUM))
        success = false;
#endif
#if defined(FAN3)
    if(!configureFanPwm(FAN3_INDEX, FAN3_PWM_CHANNEL, FAN3_PWM_RESOLUTION_BITS, FAN3_PWM_FREQUENCY_HZ, FAN3_PWM_DEFAULT_DUTY,
                        FAN3_PWM_ERROR_DUTY, FAN3_PWM_MIN_DUTY, FAN3_PWM_MAX_DUTY, FAN3_PWM_GPIO_NUM))
        success = false;
#endif
#if defined(FAN4)
    if(!configureFanPwm(FAN4_INDEX, FAN4_PWM_CHANNEL, FAN4_PWM_RESOLUTION_BITS, FAN4_PWM_FREQUENCY_HZ, FAN4_PWM_DEFAULT_DUTY,
